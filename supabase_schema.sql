...
-- Table for static TPA questions
CREATE TABLE IF NOT EXISTS public.tpa_questions (
...
ALTER TABLE public.subtest_sessions ENABLE ROW LEVEL SECURITY;
ALTER TABLE public.subtest_session_items ENABLE ROW LEVEL SECURITY;
ALTER TABLE public.tpa_questions ENABLE ROW LEVEL SECURITY;
ALTER TABLE public.admins ENABLE ROW LEVEL SECURITY;

CREATE POLICY "Enable read access for all users on tpa_questions" ON public.tpa_questions FOR SELECT USING (true);
